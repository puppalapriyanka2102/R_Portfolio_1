...
# knit: (function("C:/rstat_ana/R_Portpolio_1/project.rmd", encoding) {
#   out_dir <- 'docs';
#   rmarkdown::render("C:/rstat_ana/R_Portpolio_1/project.rmd",
#  encoding=encoding,
#  output_file=file.path(dirname("C:/rstat_ana/R_Portpolio_1/project.rmd"), out_dir, 'index.html'))})
--- 
